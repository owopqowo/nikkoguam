...
<!-- 게시판 목록 시작 -->
<div class="radius event">
<!-- sub nav -->
<div class="sub_nav_wrap">
	<div class="sub_nav">
		<ul>
			<li><a href="<?php echo G5_BBS_URL;?>/board.php?bo_table=notice"><span>공지사항</span></a></li>
			<li class="on"><a href="<?php echo G5_BBS_URL;?>/board.php?bo_table=event"><span>이벤트</span></a></li>
...
<p class="wave">이벤트</p>
<p><strong class="blue">HOTEL NIKKO GUAM</strong>이<br>준비한 다양한 이벤트를 만나보세요.</p>
<div id="bo_gall">
            ...
            <ul class="gall_con">
                <li class="gall_href">
                    ...
                    <?php
						...
						$event_frdate = $list[$i]['wr_1'];
						$event_todate = $list[$i]['wr_2'];
						$class = (($event_frdate <= G5_TIME_YMD && $event_todate >= G5_TIME_YMD) == false)? '<span class="state state_end">마감</span>':'<span class="state state_onging">진행중</span>';
                ...
                <li class="gall_text_href">
                    ...
                    <?php } ?>
                    <a href="<?php echo $list[$i]['href'] ?>">
												<h4><strong><?php echo $list[$i]['subject'] ?></strong><h4>
												<p><?php echo nl2br($list[$i]['wr_3']);?></p>
												<span class="date"><?php echo str_replace('-', '.', $list[$i]['wr_1']);?> ~ <?php echo str_replace('-', '.', $list[$i]['wr_2']);?></span>
