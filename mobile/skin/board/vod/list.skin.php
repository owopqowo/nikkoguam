            ...
            <ul class="gall_con">
                <li class="gall_href">
                    ...
                    <?php
                        ...
                        if($img_src) {
                            $img_content = '<img src="'.$img_src.'" alt="'.htmlspecialchars($list[$i]['wr_subject']).'" width="'.$board['bo_mobile_gallery_width'].'" height="'.$board['bo_mobile_gallery_height'].'">';
                        } else {
                            // 썸네일. (유투브 코드로 썸네일처리)
                            if ($list[$i]['wr_1']) {
                                $img_content = '<img src="http://img.youtube.com/vi/'.$list[$i]['wr_1'].'/hqdefault.jpg" alt="'.htmlspecialchars($list[$i]['wr_subject']).'" width="'.$board['bo_mobile_gallery_width'].'" height="'.$board['bo_mobile_gallery_height'].'">';
                            }
                            else {
