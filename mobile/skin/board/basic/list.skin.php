...
<div class="sub_nav_wrap">
	<div class="sub_nav">
		<ul>
			<li class="on"><a href="<?php echo G5_BBS_URL;?>/board.php?bo_table=notice"><span>공지사항</span></a></li>
...
<p class="wave">공지사항</p>
<p><strong class="blue">HOTEL NIKKO GUAM</strong>이 새로운 소식을<br>전해드립니다.</p>
            ...
            <td class="td_subject">
                ...
                <a href="<?php echo $list[$i]['href'] ?>">
                    ...
                    ?>
								...
								<div class="date_view">
									<span><?php echo date("y-m-d", strtotime($list[$i]['datetime'])) ?></span>
									<span><?php echo $list[$i]['wr_hit'] ?></span>
								</div>

                <?php if ($list[$i]['is_notice']) echo "<span class='icon_noti'>Notice</span>"; ?>
            </td>
...
$tmp_qstr = (count($_params))? '?'.http_build_query($_params):'';
?>
<div class="pager">
<?php if ($total_page > 1 && $page > 1) printf('<a href="%s" class="prev">이전</a>', $_SERVER['SCRIPT_NAME'].$tmp_qstr.'&amp;page='.($page-1)); ?>
	<p class="num">
		<strong><?php echo $page;?></strong>/<span><?php echo $total_page;?></span>
	</p>
<?php if ($total_page > 1 && $page < $total_page) printf('<a href="%s" class="next">다음</a>', $_SERVER['SCRIPT_NAME'].$tmp_qstr.'&amp;page='.($page+1)); ?>
</div>
<!-- //pager -->

<fieldset class="box_sch">
    ...
    <input type="hidden" name="sop" value="and">
		<div class="input_sch">
			<input type="text" name="stx" value="<?php echo stripslashes($stx) ?>" placeholder="검색어를 입력해 주세요." required id="stx" class="required frm_input" size="15" maxlength="20">
